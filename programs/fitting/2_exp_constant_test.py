...
from fitting.FittingUtils import fit_hot_temperature, plot_fit, reverse_normalize, print_fit_results, save_fit_results, _fit_using_two_exponentials_with_bias
...
if __name__ == "__main__":
    ...
    for histogram in histograms:
        ...
        results = _fit_using_two_exponentials_with_bias(histogram)
        results["histogram"] = histogram[2]
        results["2exp"] = results
        plot_fit(histogram, results, fit_type="2exp", save_path=FOLDER_SAVE_2EXP_WC)
        print(results)