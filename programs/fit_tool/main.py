...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def populate_table_column_with_data(self, data, col):
        ...
        self.tableWidget.setItem(7,col,QTableWidgetItem(data.a)) 
        self.tableWidget.setItem(8,col,QTableWidgetItem(data.b)) 
        self.tableWidget.setItem(9,col,QTableWidgetItem(data.c)) 
        self.tableWidget.setItem(10,col,QTableWidgetItem(data.d)) 
        self.tableWidget.setItem(11,col,QTableWidgetItem(data.e)) 
        self.tableWidget.setItem(12,col,QTableWidgetItem(data.f)) 
        self.tableWidget.setItem(13,col,QTableWidgetItem(data.g)) 
