...
if __name__ == "__main__":
    ...
    x_ss = np.array([[i, 4, 0] for i in i_space])
    ...
    popt, pcov = curve_fit(power, x_pred[:, 0][3:], t_pred[3:], p0=[0.001, 1/2])
    ...
    plt.xscale("log")
    plt.yscale("log")
    plt.yticks([2e1,5e2,1e2, 2e2, 5e2], ["20","50","100", "200", "500"])
    ...
    plt.ylim(10, 10**3)
    plt.savefig(PATH_TO_FIGURES + "cui_compare3.pdf")
    plt.show()
